  ...
  <section class="section">
    <footer class="container-fluid m-0 p-0">
      <div class="container-fluid p-0 m-0 row p-5 text-center justify-content-between">
        <div class=" col-md-6 col-lg-4 mb-4 ">
          ...
          <ul class="text-start mt-5 p-0">
            ...
            <svg class="m-2" width="26" height="34" viewBox="0 0 26 34" fill="none"
                ...
                <path
                    d="M13 14.9969C13.8284 14.9969 14.5 14.3006 14.5 13.4417C14.5 12.5828 13.8284 11.8865 13 11.8865C12.1716 11.8865 11.5 12.5828 11.5 13.4417C11.5 14.3006 12.1716 14.9969 13 14.9969Z"
        ...
        <div class=" col-md-6 d-none d-md-block d-lg-none mb-5 px-lg-5">
          ...
          <div class="h-100 d-grid">
            <div style="align-self: start" class="d-flex justify-content-between mt-5">
              <a class="telegram cursor-pointer">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                      d="M20 38C29.941 38 38 29.941 38 20C38 10.0589 29.941 2 20 2C10.0589 2 2 10.0589 2 20C2 29.941 10.0589 38 20 38Z"
                      stroke="currentColor" stroke-opacity="0.7" stroke-width="3" stroke-linecap="round"
                      stroke-linejoin="round"/>
                </svg>
              </a>
              <a class="instagram cursor-pointer">
                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                      ...
                      stroke-linejoin="round"/>
                  <path
                      d="M2 26.5556V11.4444C2 6.22843 6.22843 2 11.4444 2H26.5556C31.7715 2 36 6.22843 36 11.4444V26.5556C36 31.7715 31.7715 36 26.5556 36H11.4444C6.22843 36 2 31.7715 2 26.5556Z"
                      stroke="currentColor" stroke-opacity="0.7" stroke-width="3"/>
                  <path d="M29.3889 8.62987L29.4078 8.60889" stroke="currentColor" stroke-opacity="0.7" stroke-width="3"
                        stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </a>
              <a class="facebook cursor-pointer">
                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                      ...
                      stroke-linejoin="round"/>
                  <path
                      d="M17.1111 35.9999C17.1111 30.3332 17.1111 24.6666 17.1111 18.9999C17.1111 14.8679 18.0555 11.4443 24.6666 11.4443"
                      stroke="currentColor" stroke-opacity="0.7" stroke-width="3" stroke-linecap="round"
                      stroke-linejoin="round"/>
            ...
            <div style="align-self: center" class="text-center">
              <img src="/img/logo-persian.png" width="120px" alt="">
            </div>
            <div style="align-self: center">
              <p class="fw-bold mb-0">تمامی حقوق این وبسایت متعلق به شرکت
                <br class="d-sm-none">
                <span class="text-danger"> آماده لذیذ</span> است.</p>
            </div>
          </div>
        </div>
...
.telegram svg path, .instagram svg path, .facebook svg path {
  stroke: white;
  transition: 0.5s ease;
}
...
.telegram:hover svg path {
  stroke: #3384d5 !important;
}

.instagram:hover svg path {
  stroke: #d900bc !important;
}
